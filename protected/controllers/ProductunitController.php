...
class ProductunitController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Productunit']))
		{
			...
			if($model->save())
				$this->redirect(array('products/view','id'=>$model->pcode));
		}
	...
	public function actionDelete($id)
	{
		...
		if(!isset($_GET['ajax']))
			$this->redirect(isset($_POST['returnUrl']) ? $_POST['returnUrl'] : array('products/index'));
	}
	...
	{
		$dataProvider=new CActiveDataProvider('Productunit');
	...
	{
		$model=Productunit::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Productunit $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='productunit-form')
		{
