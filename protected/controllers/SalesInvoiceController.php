...
class SalesInvoiceController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['SalesInvoice']))
		{
			...
			if($model->save())
				...
				$logC->description= "Created an Sales Invoice: <a href=/Linckt/index.php?r=salesInvoice/view&id=". $model->id . ">" . $model->purchase_order_id . "</a> has been added";
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['SalesInvoice']))
		{
			...
			$logU->description= "Updated an Sales Invoice: <a href=/Linckt/index.php?r=salesInvoice/view&id=". $model->id . ">" . $model->purchase_order_id . "</a>";
	...
	public function actionDelete($id)
	{
                ...
                //Logs
                    $logU=new Logs;
			$logU->emp_id= Yii::app()->user->id;
                       $logU->description= "A Sales Invoice Has been Remove: <b>" .$model->purchase_order_id ."</b>"  ;
